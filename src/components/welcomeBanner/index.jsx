...
const WelcomeBanner = () => {
  return (
    <section className="w-full relative">
      <div className="relative h-xxl -z-10">
        ...
        <div className="z-50 flex items-center flex-wrap text-white w-full h-full">
          <div className="z-50 w-full text-center space-y-8">
            <h1 className="text-7xl font-medium w-full">Alien Store</h1>
      ...
      <div className="px-20">
        <aside
          className="-mt-20 shadow-[0_4px_0_0_rgba(0,0,0,1)] border-2 border-black rounded-3xl overflow-hidden z-50 overflow-hidden text-white lg:grid bg-gradient-to-r from-orange-400 to-orange-700 lg:grid-cols-2 lg:items-center"
        >
          <div className="p-12 text-center sm:p-16 lg:p-24 lg:text-left">
            <div className="max-w-lg mx-auto lg:ml-0 lg:pt-12">
              ...
              <Link href="/products/demo">
                <a
                  className="mt-8 relative inline-block text-sm font-medium text-orange-600 group active:text-orange-500 focus:outline-none focus:ring"
                  href="/download">
                  <span
                  ...
                  />
                  <span className="relative block px-8 py-3 bg-white border border-current text-lg">
                      Buy It!
                  </span>
                </a>
              </Link>
